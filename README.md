...
* **Traceable Evidence:** Every extracted variant is linked back to its source **PubMed ID (PMID)**.
* **Hybrid GPU Support:** Optimized for NVIDIA GPUs (e.g., RTX 3050) using CUDA.

## 🛠️ Installation & Setup

### 1. Environment Setup
```bash
git clone [https://github.com/yourusername/biominer.git](https://github.com/yourusername/biominer.git)
cd biominer
...
## 🤝 Contribution
For team members at the lab: Please ensure you do not commit your config.py file to the repository. Use the existing_pmids check to avoid redundant API calls.
